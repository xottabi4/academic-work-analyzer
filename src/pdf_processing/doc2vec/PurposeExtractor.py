...
def train(trainData, modelName):
    ...
    # model = Doc2Vec(dm=0, vector_size=100, negative=5, hs=0, min_count=2, sample=0, epochs=20, workers=cores,
    ...
    print("Finished training. It took {} сseconds".format(elapsed))
...
def testModelUsingCosDistance(testDatabase, modelName):
